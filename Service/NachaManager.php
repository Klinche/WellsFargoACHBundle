...
class NachaManager {
     ...
     *     "wellsFargoTransmissionHost"                  = @DI\Inject("%wellsfargo.transmission_host%"),
     *     "wellsFargoTransmissionUsername"              = @DI\Inject("%wellsfargo.transmission_username%"),
     *     "wellsFargoTransmissionPrivateKey"            = @DI\Inject("%wellsfargo.transmission_private_key%"),
     *     "wellsFargoTransmissionPrivateKeyPassword"    = @DI\Inject("%wellsfargo.transmission_private_key_password%"),
     *     "wellsFargoTransmissionPublicKey"             = @DI\Inject("%wellsfargo.transmission_public_key%"),
     *     "wellsFargoTransmissionInboundFolder"         = @DI\Inject("%wellsfargo.inbound_folder%"),
     *     "wellsFargoTransmissionOutboundFolder"        = @DI\Inject("%wellsfargo.outbound_folder%"),
     *     "wellsFargoTransmissionArchiveOutFolder"      = @DI\Inject("%wellsfargo.archive_out_folder%"),
